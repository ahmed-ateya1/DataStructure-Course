...
{
    phoneHash table(3);
    table.put(phoneEntery("ali", "604-401-120"));
    table.put(phoneEntery("osama", "604-401-777"));
    table.put(phoneEntery("ali", "604-401-343"));
    table.put(phoneEntery("ahmed", "604-401-17"));
    table.put(phoneEntery("hany", "604-401-758"));
    table.put(phoneEntery("ateya", "604-401-550"));
    table.put(phoneEntery("ayman", "604-401-223"));
